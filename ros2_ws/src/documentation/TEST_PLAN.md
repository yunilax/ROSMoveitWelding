...
**Основание:** раздел 5 ТЗ, Приложение Ш (матрица требований), АВПО/FMEA (Приложение Т)  
...
**PASS:** RMS ≤ 0,30 мм на контрольных точках (≥ 20 точек); протокол с числом.
...
| Шаг | Действие |
|---|---|
| 1 | Подать облако с RMS > 0,30 мм (недостаточно точек) |
...
**PASS:** plan rejected; сварка заблокирована; событие АВПО (FMEA) #4.
...
### Блок F — Безопасность и АВПО (FMEA)
...
**PASS:** реакция соответствует АВПО (FMEA) (Приложение Т).
